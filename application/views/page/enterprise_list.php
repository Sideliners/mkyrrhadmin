    ...
    <div class="row-fluid" id="article-list">
        <ul class="thumbnails"> 
            ...
            <li class="span3" style="margin-left: 0px; margin-right: 1.5%;">
                <div class="thumbnail">
	                <div class="enterprise_checkbox">
                    	<input type="checkbox" class="ace enterprise-item" name="enterprise_item[]" value="<?=$row->enterprise_id;?>" /><span class="lbl"></span>
                    </div>
                    <?php if(!empty($row->enterprise_image)): ?><img src="<?=base_url('uploads/images/enterprises/'.$row->enterprise_image);?>" /><?php endif; ?>
                    <div class="caption">
                        <h5><?=$row->enterprise_name;?><br /><small>(<?php echo ($row->enterprise_status == 1) ? "Published" : "Unpublished"; ?>)</small></h5>
                        <p>
                        	<small>
							<?php echo ($row->enterprise_description) ? substr(strip_tags($row->enterprise_description), 0, 150).'...' : 'No Description';?>
                            </small>
                         </p>
